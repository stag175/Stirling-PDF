  ...
  const actions = useMemo<QuickAction[]>(() => {
      ...
      return [
        {
          ...
          icon: <LocalIcon icon="upload-file-rounded" width={18} height={18} />,
    ...
    if (summary.fileCount === 1) {
        ...
        return [
          {
            key: "convert",
            icon: (
              <LocalIcon icon="picture-as-pdf-rounded" width={18} height={18} />
            ),
            title: text,
            onClick: send(text),
          },
      ...
      if (hasMultiplePages) {
        ...
        result.push({
          key: "split",
          icon: <LocalIcon icon="content-cut-rounded" width={18} height={18} />,
          title: text,
          onClick: send(text),
        });
      }
      ...
      result.push({
        key: "compress",
        icon: <LocalIcon icon="compress-rounded" width={18} height={18} />,
        title: compressText,
        onClick: send(compressText),
      });
      result.push({
        key: "rotate",
        icon: <LocalIcon icon="rotate-right-rounded" width={18} height={18} />,
        title: rotateText,
    ...
    result.push({
      key: "merge",
      icon: <LocalIcon icon="layers-rounded" width={18} height={18} />,
      title: mergeText,
