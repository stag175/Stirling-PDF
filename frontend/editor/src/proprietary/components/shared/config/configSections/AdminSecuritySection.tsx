    ...
    <div className="settings-section-container">
      <Stack gap="lg" className="settings-section-content">
              ...
              <NumberInput
                ...
                label={
                  <Group component="span" gap="xs">
                    ...
                    <PendingBadge
                      show={isFieldPending("loginResetTimeMinutes")}
                    />
                  </Group>
                }
                description={t(
        ...
        >
          <Text size="sm">
            {t(
              "admin.settings.security.ssoNotice.message",
              "OAuth2 and SAML2 authentication providers have been moved to the Connections menu for easier management.",
            )}
          </Text>
        </Alert>
              ...
              <NumberInput
                ...
                label={
                  <Group component="span" gap="xs">
                    ...
                    <PendingBadge
                      show={isFieldPending("jwt.tokenExpiryMinutes")}
                    />
                  </Group>
                }
                description={t(
              ...
              <NumberInput
                ...
                label={
                  <Group component="span" gap="xs">
                    ...
                    <PendingBadge
                      show={isFieldPending("audit.retentionDays")}
                    />
                  </Group>
                }
                description={t(
          ...
          <Stack gap="md">
            ...
            >
              ...
              <Group gap="xs">
                ...
                />
                <PendingBadge
                  show={isFieldPending("html.urlSecurity.enabled")}
                />
              </Group>
            </div>
              ...
              <Select
                ...
                label={
                  <Group component="span" gap="xs">
                    ...
                    <PendingBadge
                      show={isFieldPending("html.urlSecurity.level")}
                    />
                  </Group>
                }
                description={t(
                    ...
                    >
                      ...
                      <Group gap="xs">
                        <Switch
                          ...
                          checked={
                            settings?.html?.urlSecurity?.blockCloudMetadata ||
                            false
                          }
                          onChange={(e) =>
                            setSettings({
