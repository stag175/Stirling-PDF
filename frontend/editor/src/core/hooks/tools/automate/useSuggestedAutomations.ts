  ...
  const suggestedAutomations = useMemo<SuggestedAutomation[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        description: t(
          "automation.suggested.emailPreparationDesc",
          "Optimizes PDFs for email distribution by compressing files, splitting large documents into 20MB chunks for email compatibility, and removing metadata for privacy.",
        ),
        operations: [
          {
            operation: "compress",
      ...
      },
      {
        ...
        description: t(
          "automation.suggested.secureWorkflowDesc",
          "Secures PDF documents by removing potentially malicious content like JavaScript and embedded files, then adds password protection to prevent unauthorized access. Password is set to 'password' by default.",
        ),
        operations: [
          {
            operation: "sanitize",
      ...
      },
      {
        ...
        description: t(
          "automation.suggested.processImagesDesc",
          "Converts multiple image files into a single PDF document, then applies OCR technology to extract searchable text from the images.",
        ),
        operations: [
          {
            operation: "convert",
