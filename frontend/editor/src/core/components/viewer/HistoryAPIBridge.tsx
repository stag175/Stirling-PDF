...
export const HistoryAPIBridge = forwardRef<HistoryAPI>(
      ...
      const handleAnnotationEvent = (event: any) => {
        ...
        if (
          ...
          if (
            storedImageData &&
            annotation.imageSrc &&
            annotation.imageSrc !== storedImageData
          ) {
            const newId = uuidV4();
            ...
            try {
              ...
              console.error(
                "HistoryAPI: Failed to restore cropped signature:",
                restoreError,
              );
            }
            return;
          ...
          if (
            ...
            setTimeout(() => {
              ...
              if (
                currentStoredData &&
                (!annotation.imageSrc ||
                  annotation.imageSrc !== currentStoredData)
              ) {
                ...
                try {
                  ...
                  console.error(
                    "HistoryAPI: Failed to restore annotation:",
                    error,
                  );
                }
              }
