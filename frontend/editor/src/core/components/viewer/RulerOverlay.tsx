...
// Re-exported so existing consumers (e.g. EmbedPdfViewer) keep importing these
// types from RulerOverlay.
export type { MeasureScale, PageMeasureScales, PageScaleInfo, ViewportScale };
